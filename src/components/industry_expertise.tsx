    ...
    items: [
      {
        label: "Food & Beverage",
        image:
          "https://cloudgaia.com/storage/2025/01/logo-salesforce-expert.svg",
      },
      {
    ...
    items: [
      {
        ...
        image:
          "https://cloudgaia.com/storage/2025/01/logo-salesforce-specialist-II.svg",
      },
      {
        label: "Insurance",
        image:
