  ...
  return (
    <footer className="bg-[#474747] text-white px-6 md:px-20 py-10 w-full z-10 relative">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6 mt-16 text-sm">
        ...
        {/* Services */}
        <div>
          <h4 className="font-semibold mb-2 text-gray-400">Services</h4>
        ...
        {/* Industries */}
        <div>
          <h4 className="font-semibold mb-2 text-gray-400">Industries</h4>
          <ul className="space-y-1 text-gray-400">
            {[
        ...
        {/* Resources */}
        <div>
          <h4 className="font-semibold mb-2 text-gray-400">Resources</h4>
          <ul className="space-y-1 text-gray-400">
        ...
        {/* Careers */}
        <div>
          <h4 className="font-semibold mb-2 text-gray-400">Careers</h4>
          <ul className="space-y-1 text-gray-400">
            {[
        ...
        {/* Company */}
        <div>
          <h4 className="font-semibold mb-2 text-gray-400">Company</h4>
          <ul className="space-y-1 text-gray-400">
            {[
