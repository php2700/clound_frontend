...
const testimonials = [
    ...
    {
        quote: "The culture here is incredible. I feel supported and empowered to do my best work every single day. The opportunities for growth are endless.",
        name: "Jane Smith",
...
const accordionData = [
    {
        title: 'Venture',
        description: 'We encourage you to explore new paths, take on challenges, and grow both personally and professionally.',
        bgColor: 'bg-[#00838A]',
        textColor: 'text-white',
    },
    {
        title: 'Include',
        description: 'We foster a diverse and inclusive environment where every voice is heard, valued, and respected.',
        textColor: 'text-gray-800',
        bgColor: 'bg-[#FFB81C]',
    },
    {
        title: 'Believe',
        description: "We're driven by the belief that our work can contribute to a better world, making a meaningful impact every day.",
        bgColor: 'bg-[#E83F6F]',
        textColor: 'text-white',
    },
    {
        title: 'Enjoy',
        description: 'We celebrate the journey, finding joy in our successes, our growth, and the time we share as a team.',
        bgColor: 'bg-[#4a4a4a]',
        textColor: 'text-white',
    }
];
...
const jobPositions = [
    ...
    { title: 'Salesforce Release Manager', department: 'Operations', type: 'Remote' },
            ...
            <div className="container mx-auto pt-[80px] px-4 md:px-6 ">
                <div className="px-6 py-10 md:px-20 ">
                    ...
                    <div className="text-2xl">
                        Join a multicultural team of Salesforce
                        experts who elevate businesses through
                        technology.
                    </div>
                </div>
            </div>
                ...
                <div className="container mx-auto pt-[80px] px-4 md:px-6">
                    <div className="px-6 py-10 md:px-20">
                        ...
                        <div className="text-center">
                            It’s the way we work, the way we
                            connect, and the way we create
                            together. We’re committed to building
                            a safe and
                        </div>
                        <div className="text-center">
                            inclusive space where people come
                            first—where you can be yourself, grow,
                            and thrive as part of a team that
                            supports
                        </div>
                        <div className="text-center">
                            and inspires you.
            ...
            <div className="bg-white py-16">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-center text-gray-600 mb-16 max-w-2xl mx-auto">
                        Here, it's not just about work—it's about working together to create something extraordinary.
                    </p>
                    <div className="text-center mb-12">
                        ...
                        <p className="max-w-4xl mx-auto text-gray-600 text-lg">
                            We're here to empower you to become the best version of yourself every day, offering the flexibility to shape your work experience around your unique needs and goals. Whether it's how, when, or where you work, we're by your side, creating the space for you to grow, thrive, and make an impact.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
                        <div className="bg-white rounded-xl shadow-md p-8 flex flex-col sm:flex-row items-center gap-8">
                            ...
                            <div className="text-gray-700">
                                <ul className="list-disc list-inside space-y-3">
                                    <li>Work from home, the office, or a coworking space—it's your choice!</li>
                                    <li>The freedom to work from anywhere in the world (1 month).</li>
                                </ul>
                            </div>
                        </div>
                        <div className="bg-white rounded-xl shadow-md p-8 flex flex-col sm:flex-row items-center gap-8">
                        ...
                        <div className="bg-white rounded-xl shadow-md p-8 flex flex-col sm:flex-row items-center gap-8">
                            ...
                            <div className="text-gray-700">
                                <ul className="list-disc list-inside space-y-3">
                                    <li>Free Salesforce certifications and other related certifications</li>
 ...
 <div className="bg-white py-16">
                        ...
                        <div className="max-w-3xl mx-auto text-center flex flex-col items-center relative z-10">
                            ...
                            <div className="mt-8">
                                <div className="flex items-center justify-center gap-3">
                                    <img src={currentTestimonial.flag} alt={`${currentTestimonial.name}'s country flag`} className="w-8 h-auto rounded-sm" />
                                    <span className="font-bold text-lg text-yellow-400">{currentTestimonial.name}</span>
                                </div>
                                <p className="text-gray-300 mt-1">{currentTestimonial.title}</p>
                            </div>
                            <div className="flex gap-4 mt-8">
                                <button onClick={handlePrevTestimonial} className="bg-yellow-400 text-gray-800 p-3 rounded-full hover:bg-pink-500 transition-colors ">
                                    <FaArrowLeft />
                                </button>
                                <button onClick={handleNextTestimonial} className="bg-yellow-400 text-gray-800 p-3 rounded-full hover:bg-pink-500 transition-colors">
                                    <FaArrowRight />
                                </button>
                            </div>
                        </div>
            ...
            <div className="relative w-full py-24">
                ...
                <div className="relative z-10 container mx-auto px-4">
                    ...
                    <form onSubmit={handleSubmit} className="max-w-5xl mx-auto p-8 sm:p-10 rounded-xl shadow-2xl">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            <input type="text" name="firstName" placeholder="First Name*" className={inputStyle} onChange={handleFormChange} value={formData.firstName} required />
                            <input type="text" name="lastName" placeholder="Last Name*" className={inputStyle} onChange={handleFormChange} value={formData.lastName} required />
                            <input type="tel" name="mobile" placeholder="Mobile*" className={inputStyle} onChange={handleFormChange} value={formData.mobile} required />
                            <input type="email" name="email" placeholder="Email*" className={inputStyle} onChange={handleFormChange} value={formData.email} required />
                            <div className="relative"><select name="country" className={selectStyle} onChange={handleFormChange} value={formData.country} required><option value="" disabled>Country*</option><option value="USA">United States</option><option value="Canada">Canada</option><option value="Colombia">Colombia</option><option value="India">India</option></select><FaAngleDown className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none" /></div>
                            <div className="relative"><select name="area" className={selectStyle} onChange={handleFormChange} value={formData.area} required><option value="" disabled>Area*</option><option value="Development">Development</option><option value="Sales">Sales</option><option value="Marketing">Marketing</option><option value="Support">Support</option></select><FaAngleDown className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none" /></div>
                            <input type="url" name="linkedin" placeholder="LinkedIn*" className={`${inputStyle} md:col-span-3`} onChange={handleFormChange} value={formData.linkedin} />
                            <textarea name="message" placeholder="Message*"  rows="3" className={`${inputStyle} md:col-span-3`} onChange={handleFormChange} value={formData.message} required></textarea>
                        </div>
                        <div className="mb-6">
                            <p className="text-xs text-gray-500">By continuing, I confirm that I have read and agree to the Privacy Policy.</p>
                        </div>
                        <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
                            <div className="w-full sm:w-auto border border-gray-300 rounded-md p-3 bg-gray-50 flex items-center justify-between gap-4">
                                <div className="flex items-center gap-4">
                                    <input type="checkbox" id="recaptcha-mock" className="h-6 w-6 border-gray-300 rounded" />
                                    <label htmlFor="recaptcha-mock" className="text-gray-800">I'm not a robot</label>
                                </div>
                                <img src="https://www.gstatic.com/recaptcha/api2/logo_48.png" alt="reCAPTCHA logo" className="h-8" />
                            </div>
                            <button type="submit" className="w-full sm:w-auto bg-gray-200 text-gray-800 font-bold py-2 px-6 rounded-lg hover:bg-pink-500 transition-colors">
                                Apply
                            </button>
                        </div>
                    </form>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-4xl mx-auto space-y-10 mb-16">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-bold text-lg text-gray-800">What we offer</h3>
                                <ul className="list-disc list-inside text-gray-600 mt-2 space-y-1">
                                    <li>A dynamic and collaborative work environment</li>
                                    <li>Flexibility to work from anywhere in the world</li>
                                    <li>A supportive culture that values creativity and innovation</li>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-bold text-lg text-gray-800">Why Join Cloudgaia?</h3>
                                <ul className="list-disc list-inside text-gray-600 mt-2 space-y-1">
                                    <li>Work on cutting-edge Salesforce projects with top-tier clients.</li>
                                    <li>Be part of a high-performing, collaborative team.</li>
                                    <li>Ongoing training and support for certifications.</li>
                                    <li>Flexibility and growth opportunities within the company.</li>
                                </ul>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-bold text-lg text-gray-800">About Cloudgaia:</h3>
                                <p className="text-gray-600 mt-2">At Cloudgaia, we are passionate about digital transformation with Salesforce. We partner with companies to drive innovation, ensuring real business impact.</p>
                                <p className="text-gray-600 mt-4">Ready to take your career to the next level? <br /> Join Cloudgaia and be part of the digital evolution!</p>
                            </div>
                        </div>
                    </div>
