          ...
          <div className="px-6 py-10 md:px-10">
            <div className="mt-5 mb-5">
              <div className="flex flex-col lg:flex-row gap-5 items-start">
                ...
                <div className="lg:w-[48%] w-full sticky top-10 self-start">
                  <form
                    className="bg-[#FCC000] text-white text-bg-[#f9f9f9] p-8 rounded-xl space-y-6 "
                    onSubmit={handleSubmit}
                  >
                    <p
                      style={{ lineHeight: "1.2em" }}
                    ...
                    <label className="flex items-start text-[12px] font-light text-[#474747]">
                      ...
                      <span className="ml-2 text-[#474747]">
                        I agree to receive emails from Codescience with updates
