        ...
        <div className="bg-white max-w-6xl mx-auto mt-10 p-4 sm:p-8">
          ...
          <header className="pb-8 border-t pt-6">
            <div className="flex items-center text-sm text-[#474747] mt-8">
              ...
              <span className="mx-1 text-base font-bold">&nbsp;/</span>
              <span className="mx-1 text-base font-bold">&nbsp;CONA Services</span>
            </div>
            <div className="mx-1 flex items-center text-lg font-medium mt-4" >
              <img src="/flag-usa (1).svg" className="w-6 h-6" alt="USA Flag" />
              <span className="mx-1 text-[24px] text-[#474747] font-semibold ml-2">CONA Services - US</span>
            </div>
            {/* <div className="font-medium text-gray-800 mb-2.5"><img src="/flag-usa (1).svg" /><span> CONA Services - US</span></div> */}
            <h1 className="text-4xl md:text-5xl font-bold text-teal-600 leading-tight mt-5 mb-5">Empowering customer engagement with a scalable B2B Commerce platform</h1>
            <div style={{ fontFamily: "sans-serif,dm-sans" }} className="flex items-center gap-3 mb-5 text-[24px] text-[#474747]">  <img src="/logo-salesforce.svg" /> <span className="text-gray-700 font-medium">B2B Commerce | Marketing Cloud</span></div>
            <p style={{ fontFamily: "sans-serif,dm-sans" }} className="text-lg text-gray-600 max-w-4xl text-[18px] text-[#474747]">Unlocking the potential of Salesforce by refreshing myCoke, a scalable and digital platform designed to keep B2B customers stocked with a variety of iconic Coca-Cola products.</p>
          </header>
          {/* Main Content Grid */}
          <main className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
            <div className="bg-white text-[#008093] p-8 rounded-lg border border-gray-200 flex flex-col justify-center"><span className="text-3xl mb-4"><img src="/icon-info (13).svg"></img> </span><h2 className="text-3xl font-bold text-gray-800 mb-4 text-[#008093] text-[40px]">About CONA Services</h2><p className="text-[#f9f9f9] leading-relaxed mb-4" style={{ fontFamily: "sans-serif,dm-sans" }}>CONA Services is the leading IT support organization for the <strong className="font-semibold text-[#f9f9f9]">11 largest Coca-Cola bottlers in North America.</strong> They provide solutions for bottlers to optimally manage their day-to-day business and refresh the world.</p><p className="text-gray-600 leading-relaxed" >We partnered with the CONA Digital Office (CDO), an interdisciplinary and inter-agency team of product and engineering specialists, to work as one team and upgrade their B2B eCommerce platform with a focus on customer experience.</p></div>
            ...
            <div className="bg-[#ff83a9] p-8 rounded-lg"><span className="text-3xl mb-4"><img src="/icon-clock (17).svg" /></span><h2 className="text-3xl font-bold text-[#f9f9f9] text-[40px] mb-4">The Challenge</h2><p className="text-[#f9f9f9] leading-relaxed text-[18px] text-[#474747] cursor-pointer" style={{ fontFamily: "sans-serif,dm-sans" }}>CONA Services set out to transform its customer engagement platform through Salesforce technology. The goal: deliver a seamless, hyper-personalized buying experience for the 11 largest Coca-Cola bottlers, enabling them to streamline operations, boost loyalty, and drive growth across the region.</p></div>
            <div className="bg-[#008093] text-[f9f9f9] text-white p-8 rounded-lg"><span className="text-3xl mb-4"><img src="/icon-solution (21).svg" /></span><h2 className="text-3xl font-bold mb-4 text-[40px]  text-[#f9f9f9] ">The Solution</h2><p className="text-[#f9f9f9] leading-relaxed mb-4 text-[18px] " style={{ fontFamily: "sans-serif,dm-sans" }}>Together with Cloudgaala and Salesforce, CONA Services enhanced its B2B Commerce strategy through myCoke — one of the world's largest implementations of Salesforce B2B Commerce on Lightning.</p><p className="text-[#f9f9f9] leading-relaxed mb-4">Built with scalability, automation, and data-driven insights at its core, the platform redefined how bottlers and customers do business.</p><p className=" leading-relaxed text-[#f9f9f9]">myCoke: a scalable platform includes multiple storefronts, hyper-personalized experiences, automated recurring orders, optimized reporting, and more.</p></div>
          </main>
          {/* Results Section */}
          <section className="mt-12">
            <div className="bg-[#474747] text-[#f9f9f9] text-center p-6 rounded-lg shadow-lg text-[40px]"><h2 className="text-2xl text-[40px] md:text-3xl font-medium flex items-center justify-center gap-4" style={{ fontFamily: "sans-serif,dm-sans" }}><span><img src="/icon-stars-white (1).svg"></img></span>{resultsData.title}</h2></div>
          ...
          <section className="mt-12">
            <div className="relative rounded-lg shadow-xl overflow-hidden">
              ...
              <div className="absolute top-0 right-0 p-4 md:p-6 bg-gradient-to-l from-black/30 to-transparent rounded-tr-lg"><img src="/logos.jpg" alt="Cloudgaia Logo" className="h-8 md:h-10" /></div>
            </div>
          </section>
          {/* Solutions and Benefits Section */}
          <section className="mt-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 ">
              <div className="relative w-full rounded-lg overflow-hidden shadow-lg bg-[#008093]" style={{ paddingBottom: '56.25%' }}><iframe className="absolute top-0 left-0 w-full h-full" src={`${getEmbedUrl(featuredVideoId)}?autoplay=1&mute=1&loop=1&playlist=${featuredVideoId}&controls=1`} title="Featured YouTube video" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe></div>
