...
const Company = () => {
  ...
  return (
    <div className="relative min-h-screen bg-white">
      ...
      {/* Add this closing div to fix the syntax error */}
      ...
      <div
  className="mx-1 my-6 p-6 rounded-lg shadow-lg text-center w-full"
...
>
  ...
  <p className="text-white text-base leading-relaxed">
    In 2024, we proudly announced an investment from Salesforce Ventures, marking a significant milestone in our journey <br />
    as a leading global Salesforce partner. This partnership empowers us to expand our reach across the Americas and <br />
    Europe, bringing even greater innovation and expertise to help our clients thrive through digital transformation.
  </p>
</div>
